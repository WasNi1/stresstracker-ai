...
import { PerHariChart } from '../components/PerHariChart'
import { SleepStressChart } from '../components/SleepStressChart'
import { FaktorRow, FaktorEmpty } from '../components/FaktorRow'
import { Tag } from '../components/Tag'
import { FaktorSkeleton } from '../components/ChartSkeletons'
...
const faktorData = [
  { iconKey: 'LuActivity',   label: 'Olahraga rutin',            impact: -0.8, type: 'protektif', desc: '5/7 hari minggu ini' },
  { iconKey: 'LuMoon',       label: 'Tidur ≥7 jam',              impact: -0.6, type: 'protektif', desc: 'Turunkan stress 0.6 level' },
  { iconKey: 'LuDroplets',   label: 'Hidrasi cukup',             impact: -0.4, type: 'protektif', desc: 'Air ≥2 liter/hari' },
  { iconKey: 'LuSmartphone', label: 'Screen time sebelum tidur', impact: +0.9, type: 'risiko',    desc: 'Rata-rata 68 menit/malam' },
  { iconKey: 'LuBrain',      label: 'Beban kerja & deadline',    impact: +0.7, type: 'risiko',    desc: '5/7 hari ada deadline' },
  { iconKey: 'LuCoffee',     label: 'Konsumsi kafein tinggi',    impact: +0.5, type: 'risiko',    desc: 'Rata-rata 3.2 gelas/hari' },
]
    ...
    <MainLayout title='Insights & Tren'>
      <div className='max-w-3xl mx-auto'>
        ...
        <Section light title='Tren 20 Hari Terakhir' sub='Hover bar untuk detail. Bar dengan outline = hari olahraga.'>
          ...
          <TrendChart metric={activeMetric} data={trendData} loading={false} />
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-5 mb-5'>
          <div className='bg-teal-50 border border-teal-100 rounded-3xl p-5'>
            ...
            {faktorData.filter(f => f.type === 'protektif').length > 0
          ...
          <div className='bg-red-50 border border-red-100 rounded-3xl p-5'>
            ...
            {faktorData.filter(f => f.type === 'risiko').length > 0
